...
/**
 * A {@link PollingTask} that resolves IP addresses for service clients
 * @author luis
 */
public class ServiceClientIpResolvingPollingTask extends PollingTask {
    ...
    protected boolean runTask() {
        ...
        serviceClientService.resolveAllIpAddresses();

        // Always return false, making it sleep, because we always go through all clients
        return false;
    }
