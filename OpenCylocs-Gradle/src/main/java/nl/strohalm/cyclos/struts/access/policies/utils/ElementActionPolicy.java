...
public class ElementActionPolicy implements ActionPolicy {
    public static ElementActionPolicy create(final Nature... nature) {
        return new ElementActionPolicy(nature);
    }

    private Set<Nature> natures;
    ...
    public boolean check(final ActionDescriptor descriptor) {
        return natures.contains(LoggedUser.element().getNature());
    }
}
