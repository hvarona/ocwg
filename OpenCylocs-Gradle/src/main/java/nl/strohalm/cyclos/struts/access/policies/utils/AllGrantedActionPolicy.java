 ...
 * @author ameyer
 */
public class AllGrantedActionPolicy implements ActionPolicy {
    private static ActionPolicy INSTANCE = new AllGrantedActionPolicy();

    public static ActionPolicy instance() {
        return INSTANCE;
    }

    private AllGrantedActionPolicy() {
    }
