...
public class GroupFilterDAOImpl extends BaseDAOImpl<GroupFilter> implements GroupFilterDAO {
    ...
    public List<GroupFilter> search(final GroupFilterQuery query) throws DaoException {
        ...
        final StringBuilder hql = DatabaseHelper.getInitialQuery(getEntityType(), "gf", fetch);
        DatabaseHelper.addLikeParameterToQuery(hql, namedParameters, "gf.description", query.getDescription());
        DatabaseHelper.addLikeParameterToQuery(hql, namedParameters, "gf.name", query.getName());
        ...
        DatabaseHelper.appendOrder(hql, "gf.name");
