 ...
 * @author luis
 */
public interface AccountFeeAmountDAO extends BaseDAO<AccountFeeAmount>, InsertableDAO<AccountFeeAmount> {

    /**
     * Deletes all {@link AccountFeeAmount}s for the given account and log
     */
     ...
     */
    AccountFeeAmount forData(MemberAccount account, AccountFeeLog feeLog, Calendar date) throws EntityNotFoundException;
