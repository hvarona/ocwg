 ...
 * @author ameyer
 */
public class CertificationScheduledTask extends BaseScheduledTask {

    private CertificationServiceLocal certificationService;

    public CertificationScheduledTask() {
        super("Certification status change", false);
    }
    ...
    protected void doRun(final Calendar time) {
        certificationService.processCertifications(time);
    }
