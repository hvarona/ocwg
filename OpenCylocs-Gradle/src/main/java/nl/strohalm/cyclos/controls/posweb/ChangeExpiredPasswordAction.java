 ...
 * @author luis
 */
public class ChangeExpiredPasswordAction extends nl.strohalm.cyclos.controls.access.ChangeExpiredPasswordAction {

    @Override
    protected ActionForward handleDisplay(final ActionContext context) throws Exception {
        context.getRequest().setAttribute("hidePoswebActions", true);
