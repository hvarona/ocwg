 ...
 */
@WebService
public interface InfoTextWebService {

    /**
     * Loads an info text by alias
     */
    @Permission(ServiceOperation.INFO_TEXTS)
    @WebMethod
    InfoTextVO loadByAlias(@WebParam(name = "alias") String alias);
    ...
    @Permission(ServiceOperation.INFO_TEXTS)
    @WebMethod
    InfoTextVO loadById(@WebParam(name = "id") Long id);
    ...
    @Permission(ServiceOperation.INFO_TEXTS)
    @WebMethod
    InfoTextResultPage search(@WebParam(name = "params") InfoTextSearchParameters params);
