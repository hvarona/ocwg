 ...
 * @author luis
 */
public interface TransferAuthorizationDAO extends BaseDAO<TransferAuthorization>, InsertableDAO<TransferAuthorization> {

    /**
     * Search for authorizations
     */
    List<TransferAuthorization> search(TransferAuthorizationQuery query);
}
