 ...
 * @author luis
 */
public class SearchPendingMembersForm extends BaseQueryForm {

    private static final long serialVersionUID = -1099804042548415122L;

    public SearchPendingMembersForm() {
        setQuery("groups", Collections.emptyList());
        setQuery("customValues", new MapBean(true, "field", "value"));
        setQuery("creationPeriod", new MapBean("begin", "end"));
    }
