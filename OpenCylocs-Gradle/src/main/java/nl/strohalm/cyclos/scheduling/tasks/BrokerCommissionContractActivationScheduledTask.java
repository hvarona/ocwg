 ...
 */
public class BrokerCommissionContractActivationScheduledTask extends BaseScheduledTask {

    private CommissionServiceLocal commissionService;

    public BrokerCommissionContractActivationScheduledTask() {
        super("Accepted broker commission contracts activation", false);
    }
    ...
    protected void doRun(final Calendar time) {
        commissionService.activateAcceptedBrokerCommissionContracts(time);
    }
