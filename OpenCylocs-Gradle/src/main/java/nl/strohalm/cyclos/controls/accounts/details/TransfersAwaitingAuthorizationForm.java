 ...
 * @author luis
 */
public class TransfersAwaitingAuthorizationForm extends BaseQueryForm {

    private static final long serialVersionUID = 5281842986055491575L;

    public TransfersAwaitingAuthorizationForm() {
