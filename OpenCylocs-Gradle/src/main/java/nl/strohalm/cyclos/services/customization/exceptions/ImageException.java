...
public class ImageException extends ApplicationException {
    ...
    public static String      INVALID_DIMENSION = "error.image.dimension";
    private static final long serialVersionUID  = -4077898249813253318L;
    private String            key               = "error.image";

    public ImageException() {
        super();
    }

    public ImageException(final String key) {
        this.key = key;
    }
