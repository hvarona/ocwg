 ...
 * @author luis
 */
public class PurgeOldIndexOperationsScheduledTask extends BaseScheduledTask {

    private ApplicationServiceLocal applicationService;

    public PurgeOldIndexOperationsScheduledTask() {
        super("Purge old index operations", true);
    }
    ...
    protected void doRun(final Calendar time) {
        applicationService.purgeIndexOperations(time);
    }
