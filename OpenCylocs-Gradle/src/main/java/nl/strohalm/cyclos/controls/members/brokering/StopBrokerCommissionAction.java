...
public class StopBrokerCommissionAction extends BaseAction {
    ...
    protected ActionForward executeAction(final ActionContext context) throws Exception {
        ...
        final StopBrokerCommissionForm form = context.getForm();
        ...
        try {
            commissionService.stopCommissions(brokerCommission, broker, false);
            context.sendMessage("brokerCommission.stopped");
        } catch (final Exception e) {
            context.sendMessage("brokerCommission.error.stopping");
        }
