 ...
 * @author luis
 */
public class PurgeExpiredSessionsScheduledTask extends BaseScheduledTask {

    private AccessServiceLocal accessService;

    public PurgeExpiredSessionsScheduledTask() {
        super("Purging of expired sessions", true);
    }
    ...
    protected void doRun(final Calendar time) {
        accessService.purgeExpiredSessions();
    }
