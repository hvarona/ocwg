 ...
 * @author luis
 */
public interface MemberImportDAO extends BaseDAO<MemberImport>, InsertableDAO<MemberImport>, DeletableDAO<MemberImport> {

    /**
     * Lists the records created before the given time
     */
    List<MemberImport> listBefore(Calendar time);
