...
public class AcceptRegistrationAgreementAction extends nl.strohalm.cyclos.controls.members.AcceptRegistrationAgreementAction {
    ...
    protected ActionForward handleDisplay(final ActionMapping mapping, final ActionForm actionForm, final HttpServletRequest request, final HttpServletResponse response) {
        request.setAttribute("hidePoswebActions", true);
