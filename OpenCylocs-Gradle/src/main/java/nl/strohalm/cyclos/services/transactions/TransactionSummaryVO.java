...
/**
 * Contais report data of invoice or transaction amounts. Just keeps two kinds
 * of numbers for any transaction amounts: the total sum of amounts, and a
...
public class TransactionSummaryVO extends DataObject {
    ...
    /**
     * Returns a new transaction summary, adding one transaction with the given
     * amount
     */
    ...
    /**
     * Returns a new transaction summary, adding the given parameters to this
     * one
     */
    ...
    /**
     * Returns a new transaction summary, subtracting one transaction with the
     * given amount
     */
    ...
    /**
     * Returns a new transaction summary, subtracting the given parameters to
     * this one
     */
