 ...
 * @author luis
 */
public interface ImportedMemberDAO extends BaseDAO<ImportedMember>, InsertableDAO<ImportedMember>, UpdatableDAO<ImportedMember>, DeletableDAO<ImportedMember> {

    /**
     * Returns a summary for transactions of members without error, either credits or debits
     */
    TransactionSummaryVO getTransactions(MemberImport memberImport, boolean credits);
