 ...
 * @author luis
 */
public class ListCurrenciesAction extends BaseAction {
    ...
    protected ActionForward executeAction(final ActionContext context) throws Exception {
        ...
        request.setAttribute("editable", permissionService.hasPermission(AdminSystemPermission.CURRENCIES_MANAGE));
