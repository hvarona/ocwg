 ...
 * @author luis
 */
public class LocalCustomizedFileHandler extends BaseCustomizedFileHandler {
    ...
    @Override
    public void write(final String path, final long lastModified, final byte[] contents) {
        writeLocally(path, lastModified, contents);
    }
}
