...
public class RemovePaymentFilterAction extends BaseAction {
    ...
    protected ActionForward executeAction(final ActionContext context) throws Exception {
        final RemovePaymentFilterForm form = context.getForm();
        paymentFilterService.remove(form.getPaymentFilterId());
        context.sendMessage("paymentFilter.removed");
