 ...
 * @author luis
 */
public interface MemberRecordCustomFieldService extends BaseCustomFieldService<MemberRecordCustomField> {

    /**
     * Lists all member record custom fields for the member record type
     */
    List<MemberRecordCustomField> list(MemberRecordType recordType);
