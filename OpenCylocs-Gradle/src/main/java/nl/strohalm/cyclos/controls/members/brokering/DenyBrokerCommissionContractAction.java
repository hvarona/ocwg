 ...
 */
public class DenyBrokerCommissionContractAction extends BaseAction {
    ...
    protected ActionForward executeAction(final ActionContext context) throws Exception {
        ...
        final DenyBrokerCommissionContractForm form = context.getForm();
        final long brokerCommissionContractId = form.getBrokerCommissionContractId();
        commissionService.denyBrokerCommissionContract(brokerCommissionContractId);
        context.sendMessage("brokerCommissionContract.denied");
