 ...
 * @author luis
 */
public class AccountFeeScheduledTask extends BaseScheduledTask {

    private AccountFeeServiceLocal accountFeeService;

    public AccountFeeScheduledTask() {
        super("Account fee charging", true);
    }
    ...
    protected void doRun(final Calendar time) {
        accountFeeService.chargeScheduledFees(time);
    }
