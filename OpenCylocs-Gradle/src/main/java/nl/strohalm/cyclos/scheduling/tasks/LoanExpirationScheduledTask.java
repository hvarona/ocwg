 ...
 * @author luis
 */
public class LoanExpirationScheduledTask extends BaseScheduledTask {

    private LoanServiceLocal loanService;

    public LoanExpirationScheduledTask() {
        super("Loan expiration", false);
    }
    ...
    protected void doRun(final Calendar time) {
        loanService.alertExpiredLoans(time);
    }
