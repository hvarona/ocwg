...
public class SmsTypeDAOImpl extends BaseDAOImpl<SmsType> implements SmsTypeDAO {
    ...
    public Collection<SmsType> list() {
        ...
        final StringBuilder hql = DatabaseHelper.getInitialQuery(getEntityType(), "type");
        DatabaseHelper.appendOrder(hql, "type.order asc");
    ...
    public SmsType loadByCode(final String code) {
        final Map<String, Object> namedParameters = new HashMap<String, Object>();
        final StringBuilder hql = DatabaseHelper.getInitialQuery(getEntityType(), "type");
        DatabaseHelper.addParameterToQuery(hql, namedParameters, "code", code);
