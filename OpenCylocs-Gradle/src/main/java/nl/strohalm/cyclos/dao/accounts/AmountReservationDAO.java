 ...
 * @author luis
 */
public interface AmountReservationDAO extends BaseDAO<AmountReservation>, InsertableDAO<AmountReservation> {

    /**
     * Calculates the sum of amount reservations within the given period (optionally null, considering all time)
     */
    BigDecimal reservationDiff(Account account, Period period);
