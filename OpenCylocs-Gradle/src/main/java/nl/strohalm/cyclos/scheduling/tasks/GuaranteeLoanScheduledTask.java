 ...
 * @author ameyer
 */
public class GuaranteeLoanScheduledTask extends BaseScheduledTask {

    private GuaranteeServiceLocal guaranteeService;

    public GuaranteeLoanScheduledTask() {
        super("Guarantee's loan generation", false);
    }
    ...
    protected void doRun(final Calendar time) {
        guaranteeService.processGuaranteeLoans(time);
    }
