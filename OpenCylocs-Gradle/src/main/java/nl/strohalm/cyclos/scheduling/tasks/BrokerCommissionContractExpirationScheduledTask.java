 ...
 */
public class BrokerCommissionContractExpirationScheduledTask extends BaseScheduledTask {

    private CommissionServiceLocal commissionService;

    public BrokerCommissionContractExpirationScheduledTask() {
        super("Broker commission contracts expiration", false);
    }
    ...
    protected void doRun(final Calendar time) {
        commissionService.expireBrokerCommissionContracts(time);
    }
