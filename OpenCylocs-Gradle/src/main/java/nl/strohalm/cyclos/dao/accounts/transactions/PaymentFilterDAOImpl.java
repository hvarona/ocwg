...
public class PaymentFilterDAOImpl extends BaseDAOImpl<PaymentFilter> implements PaymentFilterDAO {
    ...
    public List<PaymentFilter> search(final PaymentFilterQuery query) {
        ...
        final StringBuilder hql = DatabaseHelper.getInitialQuery(getEntityType(), "pf", fetch);
        DatabaseHelper.addLikeParameterToQuery(hql, namedParameters, "pf.description", query.getDescription());
        DatabaseHelper.addLikeParameterToQuery(hql, namedParameters, "pf.name", query.getName());
        ...
        DatabaseHelper.addInParameterToQuery(hql, namedParameters, "pf.accountType", accountTypes);
        ...
        DatabaseHelper.appendOrder(hql, "pf.accountType.name", "pf.name");
