...
/**
 * Abstract implementation of all methods (with empty bodies) in the {@link TransferListener} interface
 * @author luis
 */
public abstract class TransferListenerAdapter implements TransferListener {
    ...
    @Override
    public void onTransferInserted(final Transfer transfer) throws ExternalException {
    }
