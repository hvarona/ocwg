 ...
 * @author luis
 */
public class LogSettingsEvent extends EventObject {

    private static final long serialVersionUID = 2786852370949002894L;

    public LogSettingsEvent(final LogSettings settings) {
        super(settings);
    }

    @Override
    public LogSettings getSource() {
        return (LogSettings) super.getSource();
    }
}
