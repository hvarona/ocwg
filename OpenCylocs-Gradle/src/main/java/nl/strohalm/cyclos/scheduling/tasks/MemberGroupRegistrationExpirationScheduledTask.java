 ...
 * @author luis
 */
public class MemberGroupRegistrationExpirationScheduledTask extends BaseScheduledTask {

    private ElementServiceLocal elementService;

    public MemberGroupRegistrationExpirationScheduledTask() {
        super("Member group registration expiration", false);
    }
    ...
    protected void doRun(final Calendar time) {
        elementService.processMembersExpirationForGroups(time);
    }
}
