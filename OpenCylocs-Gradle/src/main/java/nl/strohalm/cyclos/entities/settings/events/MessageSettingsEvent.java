 ...
 * @author luis
 */
public class MessageSettingsEvent extends EventObject {

    private static final long serialVersionUID = 2786852370949002894L;

    public MessageSettingsEvent(final MessageSettings settings) {
        super(settings);
    }

    @Override
    public MessageSettings getSource() {
        return (MessageSettings) super.getSource();
    }
}
