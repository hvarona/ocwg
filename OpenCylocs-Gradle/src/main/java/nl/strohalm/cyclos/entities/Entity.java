...
public abstract class Entity implements Serializable, Cloneable {
    ...
    /**
     * This method could be overridden by subclasses to return the entity's
     * name<br>
     * By default it invoke by reflection a getName() method, if not, returns
     * id#simple_class_name
     */
    ...
    /**
     * Should be overriden by subclasses to append variable values on the given
     * map
     */
