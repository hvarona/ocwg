 ...
 * @author jefferson
 */
public class SearchPaymentFiltersAjaxForm extends BaseBindingForm {

    private static final long serialVersionUID = 8168466032838858778L;
    ...
    public void setMemberGroups(final String[] memberGroups) {
