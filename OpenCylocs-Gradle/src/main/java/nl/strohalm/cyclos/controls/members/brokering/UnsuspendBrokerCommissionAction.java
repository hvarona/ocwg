 ...
 */
public class UnsuspendBrokerCommissionAction extends BaseAction {
    ...
    protected ActionForward executeAction(final ActionContext context) throws Exception {
        ...
        final UnsuspendBrokerCommissionForm form = context.getForm();
        ...
        try {
            ...
            context.sendMessage("brokerCommission.unsuspended");
        } catch (final Exception e) {
            context.sendMessage("brokerCommission.error.unsuspending");
        }
