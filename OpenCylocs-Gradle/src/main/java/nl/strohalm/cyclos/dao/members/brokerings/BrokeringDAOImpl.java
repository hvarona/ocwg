...
public class BrokeringDAOImpl extends BaseDAOImpl<Brokering> implements BrokeringDAO {
    ...
    public List<Brokering> search(final BrokeringQuery query) {
        ...
        final StringBuilder hql = DatabaseHelper.getInitialQuery(getEntityType(), "b", fetch);
        DatabaseHelper.addParameterToQuery(hql, namedParameters, "b.broker", query.getBroker());
        DatabaseHelper.addParameterToQuery(hql, namedParameters, "b.brokered", query.getBrokered());
        DatabaseHelper.addLikeParameterToQuery(hql, namedParameters, "b.brokered.name", query.getName());
        DatabaseHelper.addLikeParameterToQuery(hql, namedParameters, "b.brokered.user.username", query.getUsername());
        DatabaseHelper.addParameterToQueryOperator(hql, namedParameters, "b.startDate", "<", DateHelper.truncate(query.getStartExpirationDate()));
        ...
        DatabaseHelper.appendOrder(hql, "b.brokered.user.username");
