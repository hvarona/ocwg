...
public class CancelCertificationAction extends ChangeStatusCertificationAction {
    ...
    @Override
    protected Certification.Status getNewStatus() {
        return Certification.Status.CANCELLED;
    }
}
