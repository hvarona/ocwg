...
public class AccountStatusRecreationMigration implements UntraceableMigration {
    ...
    public void execute(final JDBCWrapper jdbc) throws SQLException {
        ...
        final String transferQuery = "select id, date, amount, status ,from_account_id, to_account_id, parent_id, account_fee_log_id from transfers where from_account_id = ? or to_account_id = ? order by date, id";
