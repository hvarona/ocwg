 ...
 * @author luis
 */
public interface AuthorizationLevelDAO extends BaseDAO<AuthorizationLevel>, InsertableDAO<AuthorizationLevel>, UpdatableDAO<AuthorizationLevel>, DeletableDAO<AuthorizationLevel> {
}
