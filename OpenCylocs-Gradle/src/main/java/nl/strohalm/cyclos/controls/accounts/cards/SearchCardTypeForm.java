 ...
 * @author rodrigo
 */
public class SearchCardTypeForm extends BaseQueryForm {

    private static final long serialVersionUID = -8985381859368112760L;
    ...
    public void setIgnoreDay(final boolean ignoreDay) {
        this.ignoreDay = ignoreDay;
    }

    public void setUseSecurityCode(final boolean useSecurityCode) {
