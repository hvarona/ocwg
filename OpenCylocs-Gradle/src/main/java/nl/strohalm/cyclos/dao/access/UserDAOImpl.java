...
public class UserDAOImpl extends BaseDAOImpl<User> implements UserDAO {
    ...
    public OperatorUser loadOperator(final Member member, final String username, final Relationship... fetch) throws EntityNotFoundException, DaoException {
        ...
        DatabaseHelper.appendJoinFetch(hql, OperatorUser.class, "u", Arrays.asList(fetch));
        hql.append(" where u.id = o.id");
        DatabaseHelper.addParameterToQuery(hql, namedParameters, "o.member", member);
        DatabaseHelper.addParameterToQuery(hql, namedParameters, "u.username", username);
