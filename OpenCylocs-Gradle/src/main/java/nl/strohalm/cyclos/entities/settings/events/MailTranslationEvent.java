 ...
 * @author luis
 */
public class MailTranslationEvent extends EventObject {

    private static final long serialVersionUID = 2786852370949002894L;

    public MailTranslationEvent(final MailTranslation settings) {
        super(settings);
    }

    @Override
    public MailTranslation getSource() {
        return (MailTranslation) super.getSource();
    }
}
