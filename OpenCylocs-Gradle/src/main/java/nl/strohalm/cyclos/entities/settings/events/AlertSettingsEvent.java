 ...
 * @author luis
 */
public class AlertSettingsEvent extends EventObject {

    private static final long serialVersionUID = 2786852370949002894L;

    public AlertSettingsEvent(final AlertSettings settings) {
        super(settings);
    }

    @Override
    public AlertSettings getSource() {
        return (AlertSettings) super.getSource();
    }
}
