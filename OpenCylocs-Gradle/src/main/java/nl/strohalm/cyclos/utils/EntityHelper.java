...
public class EntityHelper {
    ...
    /**
     * Returns the real class of the given entity. If it is a proxy, return the
    ...
    /**
     * Returns the real root class of the given entity. If it is a proxy, return
     * the entity class, not the proxy class. For example, if trying
    ...
    /**
     * Returns true if the specified id contains a possible entity identifier. A
     * possible entity identifier is considered valid if it is not null and
     * positive.
     */
     ...
     * @return An ArrayList of the ids. Returns an empty list if the input was
