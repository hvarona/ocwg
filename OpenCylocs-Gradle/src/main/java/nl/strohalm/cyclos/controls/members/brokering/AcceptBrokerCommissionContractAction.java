 ...
 */
public class AcceptBrokerCommissionContractAction extends BaseAction {
    ...
    protected ActionForward executeAction(final ActionContext context) throws Exception {
        ...
        final AcceptBrokerCommissionContractForm form = context.getForm();
        ...
        context.sendMessage("brokerCommissionContract.accepted");
