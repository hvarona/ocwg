 ...
 * @author luis
 */
public class BrokeringExpirationScheduledTask extends BaseScheduledTask {

    private BrokeringServiceLocal brokeringService;

    public BrokeringExpirationScheduledTask() {
        super("Brokering expiration", false);
    }
    ...
    protected void doRun(final Calendar time) {
        brokeringService.removeExpiredBrokerings(time);
    }
