 ...
 * @author luis
 */
public class TicketExpirationScheduledTask extends BaseScheduledTask {

    private TicketServiceLocal ticketService;

    public TicketExpirationScheduledTask() {
        super("Ticket expiration", true);
    }
    ...
    protected void doRun(final Calendar time) {
        ticketService.processExpiredTickets(time);
    }
