 ...
 * @author luis
 */
public class PurgeOldMailValidationsScheduledTask extends BaseScheduledTask {

    private ElementServiceLocal elementService;

    public PurgeOldMailValidationsScheduledTask() {
        super("Purge old mail validations", false);
    }
    ...
    protected void doRun(final Calendar time) {
        elementService.purgeOldEmailValidations(time);
    }
