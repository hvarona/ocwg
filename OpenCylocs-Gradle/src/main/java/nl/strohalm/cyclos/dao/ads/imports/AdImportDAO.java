 ...
 * @author luis
 */
public interface AdImportDAO extends BaseDAO<AdImport>, InsertableDAO<AdImport>, UpdatableDAO<AdImport>, DeletableDAO<AdImport> {

    /**
     * Lists the records created before the given time
     */
    List<AdImport> listBefore(Calendar time);
}
