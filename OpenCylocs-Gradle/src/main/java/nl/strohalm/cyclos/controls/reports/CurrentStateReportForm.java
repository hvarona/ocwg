...
public class CurrentStateReportForm extends BaseBindingForm {

    private static final long serialVersionUID = -179454887825621557L;

    public CurrentStateReportForm() {
    }
    ...
    public void setCurrentStateReport(final Map<String, Object> currentStateReport) {
