 ...
 * @author luis
 */
public class TransactionFeedackExpirationScheduledTask extends BaseScheduledTask {
    private ReferenceServiceLocal referenceService;

    public TransactionFeedackExpirationScheduledTask() {
        super("Transaction feedback expiration", false);
    }
    ...
    protected void doRun(final Calendar time) {
        referenceService.processExpiredFeedbacks(time);
    }
