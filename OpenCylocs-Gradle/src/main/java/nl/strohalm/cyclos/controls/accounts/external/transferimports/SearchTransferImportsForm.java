 ...
 * @author luis
 */
public class SearchTransferImportsForm extends BaseQueryForm {
    private static final long serialVersionUID = -4689707816616982197L;
    private long              externalAccountId;

    public SearchTransferImportsForm() {
